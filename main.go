...
var templates = template.Must(template.ParseFiles("./templates/signup.html", "./templates/login.html", "./templates/base.html", "./templates/index.html", "./templates/accomplishment.html", "./templates/addAccomplishment.html"))
